    ...
    <div className="min-h-screen flex flex-col bg-transparent transition-colors duration-300">
      ...
      <main className="flex-1 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 w-full space-y-16">
        ...
        {thirdPlaceCandidates.length === 12 && (
          <section className="bg-white/90 backdrop-blur-sm rounded-xl p-4 shadow-sm border border-gray-100 pt-4">
            <ThirdPlaceRanker 
        ...
        {bestThirds.length === 8 ? (
          ...
          <section className="text-center py-16 bg-white/80 backdrop-blur-sm rounded-xl border border-gray-200 shadow-sm">
