...
// ------------------------------------------------------------
// OFFICIAL THIRD‑PLACE LOOKUP (FIFA 2026 Annex C, pages 80‑98)
...
// Official allocation using the FIFA Annex C lookup table
function allocateThirdPlaceTeamsOfficial(selectedThirds: Team[]): Record<string, Team | null> {
  ...
  // Map group letter -> Team
  const groupToTeam: Record<string, Team> = {};
  const groups: string[] = [];
  for (const team of selectedThirds) {
    const grp = team.group;
    groupToTeam[grp] = team;
    groups.push(grp);
  }
  groups.sort(); // alphabetical order
  const key = groups.join(""); // e.g., "ABCDEFGH"

  const assignedGroups = THIRD_PLACE_LOOKUP[key];
  if (!assignedGroups) {
    console.error(`No lookup entry for third‑place combination: ${key}`);
    return allocation;
  }

  const slots = ["1A", "1B", "1D", "1E", "1G", "1I", "1K", "1L"];
  for (let i = 0; i < slots.length; i++) {
    const groupLetter = assignedGroups[i];
    allocation[slots[i]] = groupToTeam[groupLetter] || null;
  }
...
const matchSourceLabels: Record<number, { team1: { en: string; vi: string }; team2: { en: string; vi: string } }> = {
  ...
  73: { team1: { en: "Group A Runner-up", vi: "Nhì Bảng A" }, team2: { en: "Group B Runner-up", vi: "Nhì Bảng B" } },
  74: { team1: { en: "Group E Winner", vi: "Nhất Bảng E" }, team2: { en: "3rd Place A/B/C/D/F", vi: "Hạng 3 A/B/C/D/F" } },
  75: { team1: { en: "Group F Winner", vi: "Nhất Bảng F" }, team2: { en: "Group C Runner-up", vi: "Nhì Bảng C" } },
  76: { team1: { en: "Group C Winner", vi: "Nhất Bảng C" }, team2: { en: "Group F Runner-up", vi: "Nhì Bảng F" } },
  77: { team1: { en: "Group I Winner", vi: "Nhất Bảng I" }, team2: { en: "3rd Place C/D/F/G/H", vi: "Hạng 3 C/D/F/G/H" } },
  78: { team1: { en: "Group E Runner-up", vi: "Nhì Bảng E" }, team2: { en: "Group I Runner-up", vi: "Nhì Bảng I" } },
  79: { team1: { en: "Group A Winner", vi: "Nhất Bảng A" }, team2: { en: "3rd Place C/E/F/H/I", vi: "Hạng 3 C/E/F/H/I" } },
  80: { team1: { en: "Group L Winner", vi: "Nhất Bảng L" }, team2: { en: "3rd Place E/H/I/J/K", vi: "Hạng 3 E/H/I/J/K" } },
  81: { team1: { en: "Group D Winner", vi: "Nhất Bảng D" }, team2: { en: "3rd Place B/E/F/I/J", vi: "Hạng 3 B/E/F/I/J" } },
  82: { team1: { en: "Group G Winner", vi: "Nhất Bảng G" }, team2: { en: "3rd Place A/E/H/I/J", vi: "Hạng 3 A/E/H/I/J" } },
  83: { team1: { en: "Group K Runner-up", vi: "Nhì Bảng K" }, team2: { en: "Group L Runner-up", vi: "Nhì Bảng L" } },
  84: { team1: { en: "Group H Winner", vi: "Nhất Bảng H" }, team2: { en: "Group J Runner-up", vi: "Nhì Bảng J" } },
  85: { team1: { en: "Group B Winner", vi: "Nhất Bảng B" }, team2: { en: "3rd Place E/F/G/I/J", vi: "Hạng 3 E/F/G/I/J" } },
  86: { team1: { en: "Group J Winner", vi: "Nhất Bảng J" }, team2: { en: "Group H Runner-up", vi: "Nhì Bảng H" } },
  87: { team1: { en: "Group K Winner", vi: "Nhất Bảng K" }, team2: { en: "3rd Place D/E/I/J/L", vi: "Hạng 3 D/E/I/J/L" } },
  88: { team1: { en: "Group D Runner-up", vi: "Nhì Bảng D" }, team2: { en: "Group G Runner-up", vi: "Nhì Bảng G" } },
  
  // Round of 16 (Matches 89-96)
  89: { team1: { en: "Winner M74", vi: "Thắng Trận M74" }, team2: { en: "Winner M77", vi: "Thắng Trận M77" } },
  90: { team1: { en: "Winner M73", vi: "Thắng Trận M73" }, team2: { en: "Winner M75", vi: "Thắng Trận M75" } },
  91: { team1: { en: "Winner M76", vi: "Thắng Trận M76" }, team2: { en: "Winner M78", vi: "Thắng Trận M78" } },
  92: { team1: { en: "Winner M79", vi: "Thắng Trận M79" }, team2: { en: "Winner M80", vi: "Thắng Trận M80" } },
  93: { team1: { en: "Winner M83", vi: "Thắng Trận M83" }, team2: { en: "Winner M84", vi: "Thắng Trận M84" } },
  94: { team1: { en: "Winner M81", vi: "Thắng Trận M81" }, team2: { en: "Winner M82", vi: "Thắng Trận M82" } },
  95: { team1: { en: "Winner M86", vi: "Thắng Trận M86" }, team2: { en: "Winner M88", vi: "Thắng Trận M88" } },
  96: { team1: { en: "Winner M85", vi: "Thắng Trận M85" }, team2: { en: "Winner M87", vi: "Thắng Trận M87" } },
...
const thirdPlaceAllocations = allocateThirdPlaceTeamsOfficial(selectedBestThirds);
const initialMatches: Record<number, Match> = {};

const r32Setup = [
  // Match 73: 2A vs 2B
  { id: 73, label: "M73", t1: qualifyingTeams[1], t2: qualifyingTeams[3] },
  // Match 74: 1E vs 3rd A/B/C/D/F
  { id: 74, label: "M74", t1: qualifyingTeams[8], t2: thirdPlaceAllocations["1E"] },
  // Match 75: 1F vs 2C
  { id: 75, label: "M75", t1: qualifyingTeams[10], t2: qualifyingTeams[5] },
  // Match 76: 1C vs 2F
  { id: 76, label: "M76", t1: qualifyingTeams[4], t2: qualifyingTeams[11] },
  // Match 77: 1I vs 3rd C/D/F/G/H
  { id: 77, label: "M77", t1: qualifyingTeams[16], t2: thirdPlaceAllocations["1I"] },
  // Match 78: 2E vs 2I
  { id: 78, label: "M78", t1: qualifyingTeams[9], t2: qualifyingTeams[17] },
  // Match 79: 1A vs 3rd C/E/F/H/I
  { id: 79, label: "M79", t1: qualifyingTeams[0], t2: thirdPlaceAllocations["1A"] },
  // Match 80: 1L vs 3rd E/H/I/J/K
  { id: 80, label: "M80", t1: qualifyingTeams[22], t2: thirdPlaceAllocations["1L"] },
  // Match 81: 1D vs 3rd B/E/F/I/J
  { id: 81, label: "M81", t1: qualifyingTeams[6], t2: thirdPlaceAllocations["1D"] },
  // Match 82: 1G vs 3rd A/E/H/I/J
  { id: 82, label: "M82", t1: qualifyingTeams[12], t2: thirdPlaceAllocations["1G"] },
  // Match 83: 2K vs 2L
  { id: 83, label: "M83", t1: qualifyingTeams[21], t2: qualifyingTeams[23] },
  // Match 84: 1H vs 2J
  { id: 84, label: "M84", t1: qualifyingTeams[14], t2: qualifyingTeams[19] },
  // Match 85: 1B vs 3rd E/F/G/I/J
  { id: 85, label: "M85", t1: qualifyingTeams[2], t2: thirdPlaceAllocations["1B"] },
  // Match 86: 1J vs 2H
  { id: 86, label: "M86", t1: qualifyingTeams[18], t2: qualifyingTeams[15] },
  // Match 87: 1K vs 3rd D/E/I/J/L
  { id: 87, label: "M87", t1: qualifyingTeams[20], t2: thirdPlaceAllocations["1K"] },
  // Match 88: 2D vs 2G
  { id: 88, label: "M88", t1: qualifyingTeams[7], t2: qualifyingTeams[13] },
];
    r32Setup.forEach((m) => {
